...
import { IRolepermission, RolepermissionService, RolepermissionDetailsComponent, RolepermissionListComponent, RolepermissionNewComponent } from './index';
...
describe('RolepermissionListComponent', () => {
  ...
  let data: IRolepermission[] = [... constData];
  ...
  describe('Integration tests', () => {
      ...
      TestBed.configureTestingModule({
        ...
        imports: [
          ...
          RouterTestingModule.withRoutes([
            { path: 'rolepermission', component: RolepermissionListComponent },
            { path: 'rolepermission/:id', component: RolepermissionDetailsComponent }
          ])
        ],
        providers: [
          RolepermissionService,
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(location.path()).toBe(`/rolepermission/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`);
    });
