...
import { IVets,VetsService, VetsNewComponent } from './index';

describe('VetsNewComponent', () => {
  let component: VetsNewComponent;
  let fixture: ComponentFixture<VetsNewComponent>;
  ...
  describe('Unit tests', () => {
    ...
    beforeEach(() => {
      fixture = TestBed.createComponent(VetsNewComponent);
