...
import { IVets, VetsService, VetsDetailsComponent, VetsListComponent, VetsNewComponent } from './index';
...
describe('VetsListComponent', () => {
  ...
  describe('Integration tests', () => {
      ...
      TestBed.configureTestingModule({
        ...
        imports: [
          ...
          RouterTestingModule.withRoutes([
            ...
            { path: 'vets/:id', component: VetsDetailsComponent }
          ])
        ],
        providers: [
          VetsService,
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(location.path()).toBe(`/vets/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`);
    });
