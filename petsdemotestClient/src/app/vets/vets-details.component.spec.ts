...
import { IVets, VetsService, VetsDetailsComponent, VetsListComponent } from './index';

describe('VetsDetailsComponent', () => {
  let component: VetsDetailsComponent;
  let fixture: ComponentFixture<VetsDetailsComponent>;
  let el: HTMLElement;
  ...
  describe('Unit Tests', () => {
    ...
    beforeEach(() => {
      fixture = TestBed.createComponent(VetsDetailsComponent);
  ...
  describe('Integration Tests', () => {
      ...
      TestBed.configureTestingModule({
        ...
        imports: [
          ...
          RouterTestingModule.withRoutes([
            { path: 'vets', component: VetsDetailsComponent },
            { path: 'vets/:id', component: VetsListComponent }
          ])
        ],
        providers: [
          VetsService
    ...
    it('should update the record and redirect to list component', async () => {
      ...
      expect(location.path()).toBe('/vets');
