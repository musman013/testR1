...
import { IPermission, PermissionService, PermissionDetailsComponent, PermissionListComponent, PermissionNewComponent } from './index';
...
describe('PermissionListComponent', () => {
  ...
  describe('Integration tests', () => {
    ...
    it('should delete the item from list', async () => {
      ...
      component.deleteDialogRef.afterClosed();
      await component.deleteDialogRef.afterClosed;
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(location.path()).toBe(`/permission/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`);
    });
