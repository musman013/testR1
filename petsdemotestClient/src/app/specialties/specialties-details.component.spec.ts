...
import { ISpecialties, SpecialtiesService, SpecialtiesDetailsComponent, SpecialtiesListComponent } from './index';
...
describe('SpecialtiesDetailsComponent', () => {
  ...
  describe('Integration Tests', () => {
      ...
      TestBed.configureTestingModule({
        ...
        imports: [
          ...
          RouterTestingModule.withRoutes([
            { path: 'specialties', component: SpecialtiesDetailsComponent },
            { path: 'specialties/:id', component: SpecialtiesListComponent }
          ])
        ],
        providers: [
          SpecialtiesService
    ...
    it('should update the record and redirect to list component', async () => {
      ...
      expect(location.path()).toBe('/specialties');
