...
import { ISpecialties, SpecialtiesService, SpecialtiesDetailsComponent, SpecialtiesListComponent, SpecialtiesNewComponent } from './index';
...
describe('SpecialtiesListComponent', () => {
  ...
  let data: ISpecialties[] = [... constData];
  ...
  describe('Integration tests', () => {
      ...
      TestBed.configureTestingModule({
        ...
        imports: [
          ...
          RouterTestingModule.withRoutes([
            ...
            { path: 'specialties/:id', component: SpecialtiesDetailsComponent }
          ])
        ],
        providers: [
          SpecialtiesService,
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(location.path()).toBe(`/specialties/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`);
    });
