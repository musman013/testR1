...
import { IVetSpecialties, VetSpecialtiesService, VetSpecialtiesDetailsComponent, VetSpecialtiesListComponent, VetSpecialtiesNewComponent } from './index';

describe('VetSpecialtiesListComponent', () => {
  let fixture:ComponentFixture<VetSpecialtiesListComponent>;
  let component:VetSpecialtiesListComponent;
  let el: HTMLElement;
  let constData:IVetSpecialties[] = [
    {   
      specialtyId: 1,
      vetId: 1,
  ...
  let data: IVetSpecialties[] = [... constData];
  ...
  describe('Unit tests', () => {
    ...
    beforeEach(() => {
      fixture = TestBed.createComponent(VetSpecialtiesListComponent);
  ...
  describe('Integration tests', () => {
      ...
      TestBed.configureTestingModule({
        ...
        imports: [
          ...
          RouterTestingModule.withRoutes([
            { path: 'vetspecialties', component: VetSpecialtiesListComponent },
            { path: 'vetspecialties/:id', component: VetSpecialtiesDetailsComponent }
          ])
        ],
        providers: [
          VetSpecialtiesService,
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(location.path()).toBe(`/vetspecialties/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`);
    });
