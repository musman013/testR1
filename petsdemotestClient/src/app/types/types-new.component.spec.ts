...
import { ITypes,TypesService, TypesNewComponent } from './index';

describe('TypesNewComponent', () => {
  let component: TypesNewComponent;
  let fixture: ComponentFixture<TypesNewComponent>;
  ...
  describe('Unit tests', () => {
    ...
    beforeEach(() => {
      fixture = TestBed.createComponent(TypesNewComponent);
