...
import { ITypes, TypesService, TypesDetailsComponent, TypesListComponent } from './index';
...
describe('TypesDetailsComponent', () => {
  ...
  describe('Integration Tests', () => {
      ...
      TestBed.configureTestingModule({
        ...
        imports: [
          ...
          RouterTestingModule.withRoutes([
            { path: 'types', component: TypesDetailsComponent },
            { path: 'types/:id', component: TypesListComponent }
          ])
        ],
        providers: [
          TypesService
    ...
    it('should update the record and redirect to list component', async () => {
      ...
      expect(location.path()).toBe('/types');
