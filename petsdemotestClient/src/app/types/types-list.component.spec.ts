...
import { ITypes, TypesService, TypesDetailsComponent, TypesListComponent, TypesNewComponent } from './index';

describe('TypesListComponent', () => {
  let fixture:ComponentFixture<TypesListComponent>;
  let component:TypesListComponent;
  let el: HTMLElement;
  let constData:ITypes[] = [
    {   
      id: 1,
      name: 'name1',
    },
  ...
  describe('Integration tests', () => {
      ...
      TestBed.configureTestingModule({
        ...
        imports: [
          ...
          RouterTestingModule.withRoutes([
            ...
            { path: 'types/:id', component: TypesDetailsComponent }
          ])
        ],
        providers: [
          TypesService,
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(location.path()).toBe(`/types/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`);
    });
