...
import { IUserpermission, UserpermissionService, UserpermissionDetailsComponent, UserpermissionListComponent, UserpermissionNewComponent } from './index';
...
describe('UserpermissionListComponent', () => {
  ...
  let data: IUserpermission[] = [... constData];
  ...
  describe('Integration tests', () => {
      ...
      TestBed.configureTestingModule({
        ...
        imports: [
          ...
          RouterTestingModule.withRoutes([
            ...
            { path: 'userpermission/:id', component: UserpermissionDetailsComponent }
          ])
        ],
        providers: [
          UserpermissionService,
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(location.path()).toBe(`/userpermission/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`);
    });
