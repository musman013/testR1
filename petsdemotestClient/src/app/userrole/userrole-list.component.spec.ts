...
import { IUserrole, UserroleService, UserroleDetailsComponent, UserroleListComponent, UserroleNewComponent } from './index';

describe('UserroleListComponent', () => {
  let fixture:ComponentFixture<UserroleListComponent>;
  let component:UserroleListComponent;
  let el: HTMLElement;
  let constData:IUserrole[] = [
    {   
      roleId: 1,
      userId: 1,
  ...
  describe('Integration tests', () => {
      ...
      TestBed.configureTestingModule({
        ...
        imports: [
          ...
          RouterTestingModule.withRoutes([
            ...
            { path: 'userrole/:id', component: UserroleDetailsComponent }
          ])
        ],
        providers: [
          UserroleService,
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(location.path()).toBe(`/userrole/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`);
    });
