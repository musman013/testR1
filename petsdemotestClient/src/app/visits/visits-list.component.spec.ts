...
import { IVisits, VisitsService, VisitsDetailsComponent, VisitsListComponent, VisitsNewComponent } from './index';

describe('VisitsListComponent', () => {
  let fixture:ComponentFixture<VisitsListComponent>;
  let component:VisitsListComponent;
  let el: HTMLElement;
  let constData:IVisits[] = [
    {   
  ...
  describe('Integration tests', () => {
      ...
      TestBed.configureTestingModule({
        ...
        imports: [
          ...
          RouterTestingModule.withRoutes([
            ...
            { path: 'visits/:id', component: VisitsDetailsComponent }
          ])
        ],
        providers: [
          VisitsService,
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(location.path()).toBe(`/visits/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`);
    });
