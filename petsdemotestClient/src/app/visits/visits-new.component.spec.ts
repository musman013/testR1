...
import { IVisits,VisitsService, VisitsNewComponent } from './index';

describe('VisitsNewComponent', () => {
  let component: VisitsNewComponent;
  let fixture: ComponentFixture<VisitsNewComponent>;
  ...
  describe('Unit tests', () => {
    ...
    beforeEach(() => {
      fixture = TestBed.createComponent(VisitsNewComponent);
