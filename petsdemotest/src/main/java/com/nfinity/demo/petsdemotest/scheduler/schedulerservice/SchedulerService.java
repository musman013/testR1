package com.nfinity.demo.petsdemotest.scheduler.schedulerservice;

import com.nfinity.demo.petsdemotest.scheduler.schedulerservice.CGenClassLoader;
import com.nfinity.demo.petsdemotest.scheduler.constants.QuartzConstants;
...
import com.nfinity.demo.petsdemotest.scheduler.application.dto.*;
import com.nfinity.demo.petsdemotest.scheduler.domain.model.QJobDetailsEntity;
import com.nfinity.demo.petsdemotest.scheduler.domain.model.QJobHistoryEntity;
import com.nfinity.demo.petsdemotest.scheduler.domain.model.QTriggerDetailsEntity;
import com.nfinity.demo.petsdemotest.scheduler.domain.*;
import com.nfinity.demo.petsdemotest.scheduler.domain.model.*;
...
public class SchedulerService {
	...
	public List<GetExecutingJob> currentlyExecutingJobs() throws SchedulerException {
		...
		for (int i = 0; i < executingJobs.size(); i++) {
			...
			JobDetails jobDetail = schedulerServiceUtil.returnJobDetails(executingJobs.get(i).getJobDetail().getKey());
